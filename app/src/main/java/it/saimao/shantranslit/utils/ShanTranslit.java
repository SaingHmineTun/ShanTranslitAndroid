...
public class ShanTranslit {
    public static String taiToEngWithTone(String input) {
...
//        output = output.replaceAll("ʼa[]", "a ");
    ...
    public static String engToShn(String input) {
        String output = input.toLowerCase();

        String checkIsToneMarkIncludingOrNot = "(?!.*(?:\\u030c|\\u0300|\\u0304|\\u0301|\\u0302\\u0330|\\u1dc8))[\\s\\S]*";
        if (Pattern.matches(checkIsToneMarkIncludingOrNot, input)) {
            output = output.replaceAll("(k|kh|ng|j|z|s|ny|t|th|n|p|ph|f|m|y|r|l|w|h|ʼ)([aeiou])", "$1$2\u030c");
        }
        // y - ပျ
    ...
    @NotNull
    public static String taiToEngWithToneSideBySide(@NotNull String input) {
        String[] outputs = ShanSyllableBreaker.syllable_break(input).split(" ");
...
//        output = output.replaceAll("ʼa[]", "a ");
            ...
            sb.append(str).append("(").append(output).append(")").append(" ");
        }
    ...
    @NotNull
    public static String taiToEngWithoutToneSideBySide(@NotNull String input) {
...
//        output = output.replaceAll("ʼa[]", "a ");
    ...
    public static ConvertedText taiToEngWithToneUpsideDown(String input) {


        String shan = ShanSyllableBreaker.syllable_break(input);
        String output = shan;
        // "ၵ" "ၵျ" "တြ" ႁႂ်ႈပဵတ် ka kya tra
        output = output.replaceAll("^([\\u1075-\\u1081\\u1004\\u101e\\u1010\\u1011\\u1015\\u1019\\u101a\\u101b\\u101c\\u101d\\u1022])([\\u103b\\u103c])?$", "$1$2a");
...
//        output = output.replaceAll("ʼa[]", "a ");
        ...
        return new ConvertedText(shan, output.trim());


    }

    public static ConvertedText taiToEngWithoutToneUpsideDown(String input) {
